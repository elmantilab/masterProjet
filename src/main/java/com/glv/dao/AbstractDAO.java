...
public abstract class AbstractDAO<E> {
    ...
    public E findByID(Object id) {
        ...
        return currentSession().find((Class<E>) entityClass, id);
    }
    ...
    /**
     * Convenience method to return a single instance that matches the criteria
     * query, or null if the criteria returns no results.
     *
    ...
    /**
     * Return the persistent instance of {@code <E>} with the given identifier,
     ...
     * the unsaved-value checks (see the manual for discussion of unsaved-value
     * checking).
     * <p/>
     ...
     * {@code null}
     * @throws HibernateException if we can't initialize the proxy at this time,
     * eg. the {@link Session} was closed
     */
